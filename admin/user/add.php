...
<div class="row">
   <div class="medium-6">
      <form action="" method="post">
         <div>
            <label>No.KTP</label>
            <input class="wide text input" type="number" name="nis" placeholder="No.KTP" type="number"/>
         </div>
         <div>
            <label>Nama Pemilih</label>
            <input class="wide password input" name="nama" type="text" placeholder="Nama Sesuai KTP"/>
         </div>
         <div>
